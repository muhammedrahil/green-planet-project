                ...
                if (uname.equalsIgnoreCase("")) {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (status.equalsIgnoreCase("success")) {
                                    ...
                                    {
                                        Intent in = new Intent(getApplicationContext(), Customer_home.class);
                                    startActivity(in);
                                        Intent inn=new Intent(getApplicationContext(),LocactionService.class);
                                        startService(inn);
                                    }
                                  else  if(type.equalsIgnoreCase("vehicle"))
                                    {
                                        Intent in = new Intent(getApplicationContext(), vehicle_home.class);
                                        startActivity(in);
                                        Intent inn=new Intent(getApplicationContext(),LocactionService.class);
                                        startService(inn);
                                    }
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(login.this, error+"errrrrrrr", Toast.LENGTH_SHORT).show();
                        }
                    }) {
                        @Override
